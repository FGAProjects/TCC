...
\citeonline{sommerville} define o processo de desenvolvimento de software como "Um processo de \textit{software} é um conjunto de atividades relacionadas que levam à produção de um produto de \textit{software}."
...
Segundo \citeonline{sommerville}, as entrevistas podem ser formais ou informais, sendo está técnica uma das mais utilizadas nos processos de engenharia de requisitos. 

...
EDITAVEIS_SOURCES = informacoes.tex arquivosIniciais/dedicatoria.tex \
...
all:
	@make $(TARGET) & pdflatex tcc.tex && bibtex tcc && pdflatex tcc.tex && pdflatex tcc.tex

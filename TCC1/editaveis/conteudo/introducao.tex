...
A seguir será mostrado como funciona separadamente o \textit{React},relacionado ao \textit{front-end} e a \textit{View}, enquanto o \textit{Python Django-Rest} é responsável pelo \textit{back-end}, \textit{model} e \textit{controller}:

...
Uma metodologia de gerenciamento de projetos no modelo tradicional, de acordo com \citeonline{kerzner} é o alcance da excelência no gerenciamento de projetos e que se torna impossível sem um processo repetitivo que possa ser utilizado em cada projeto.
...
Os casos de uso é uma das principais características presentes na linguagem de modelagem UML (\textit{Unified Modeling Language}), ou linguagem modelada unificada. \citeonline{sommerville} define os objetivos dos casos de uso são de identificar os atores envolvidos e dá o nome ao tipo de interação. Os casos de uso é um diagrama de auto nível, ou seja, de fácil entendimento para o usuário final que possui os objetivos mais amplos de auxiliar a comunicação entre cliente e analistas, e apresentar as principais funcionalidades do sistema com foco no cliente.
...
O modelo ágil, segundo \citeonline{soares}, ele deve primeiro aceitar as mudanças em vez de tentar prevê-las, agir de maneira rápida sabendo receber, avaliar e responder como elas devem ser respondidas. As principais características da metodologia ágil são:

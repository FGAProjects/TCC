...
Para o auxilio no desenvolvimento, o RUP utiliza um diagrama conhecido como Casos de Uso. Este modelo é focado em auxiliar a comunicação entre cliente e analistas, apresentar as principais funcionalidades do sistema com foco no cliente e é muito utilizado na fase de levantamento dos requisitos.

Um caso de uso é composto por atores e relacionamentos. Na Figura \ref{img:exemplo_caso_de_uso} é possível visualizar um exemplo de caso de uso:

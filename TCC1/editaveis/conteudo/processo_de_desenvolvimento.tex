...
\begin{table}[H]
	...
	\textbf{Descrição} & Usuário que irá ter controle sobre o sistema e todas as funcionalidades.  \\ \hline
	...
	\textbf{O que ele precisa?} & Ele precisa de usuário e senha para conseguir acessar o sistema. visualizar um ambiente completo com todas as funcionalidades disponíveis no sistema. \\ \hline
	\end{tabular}
...
\begin{table}[H]
	...
	\textbf{O que ele precisa?} & Precisa de usuário e senha para conseguir acessar o sistema, visualizar as ATAas das reunioes que participou, podendo imprimir, baixar, e deixar comentários. \\ \hline
	\end{tabular}
...
\subsubsection{Histórias Técnicas}

As Histórias Técnicas são necessidades levantadas para cumprir questões pontuais que não necessariamente estão ligadas aos requisitos funcionais. Essas histórias podem agregar ou não valor ao produto diretamente. As histórias técnicas deste projeto estão na Tabela \ref{tab:historias_tecnicas}. 
...
\begin{table}[H]
	...
	\textbf{Segurança} & O sistema deve garantir a segurança dos dados mais críticos tais como senha dos usuários e \textit{emails}. \\ \hline
